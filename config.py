...
#por enquanto o único filtro funcional é o savitzky
filter_config = {
    ...
    "params": {
        ...
        "order": 2 # Ordem do polinômio para o filtro escolhido, quanto maior o mais próximo o sinal fica do original
    }
}
